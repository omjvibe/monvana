...
export function Blog() {
    return (
        <section className="bg-[#0a0a0a] py-24 md:py-32 relative border-t border-stone-800">
            ...
            <div className="absolute top-0 right-[10%] w-[30%] h-[50%] bg-amber-500/5 blur-[120px] rounded-full pointer-events-none" />
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {posts.map((post, index) => (
                        ...
                        >
                            <Link
                                href={post.slug}
                                className="group flex h-full flex-col rounded-3xl border border-stone-800 bg-stone-900/20 p-8 backdrop-blur-sm transition-all duration-300 hover:border-amber-500/30 hover:bg-stone-900/40 hover:shadow-xl relative overflow-hidden"
                            >
                                ...
                                <div className="relative z-10 flex flex-col h-full">
                                    {/* Category */}
                                    <span className="inline-flex w-fit rounded-full border border-stone-800 bg-stone-950/50 px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-amber-500 shadow-sm">
                                        {post.category}
                                    </span>

                                    {/* Title */}
                                    <h3 className="mt-6 text-xl font-bold text-white group-hover:text-amber-400 transition-colors font-serif leading-snug">
                                        {post.title}
                                    </h3>
