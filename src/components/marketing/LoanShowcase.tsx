...
export function LoanShowcase() {
    return (
        <section className="bg-[#0a0a0a] py-24 md:py-32 relative overflow-hidden border-t border-stone-800">
            ...
            <div className="absolute top-[20%] left-0 w-[40%] h-[40%] bg-[#00DF89]/10 blur-[120px] rounded-full pointer-events-none" />
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
                <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 lg:right-auto lg:w-64">
                                <div className="backdrop-blur-xl bg-white/10 p-5 rounded-2xl border border-white/20 shadow-2xl">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="h-8 w-8 rounded-full bg-[#00DF89]/20 flex items-center justify-center border border-[#00DF89]/30">
                                            <Landmark className="h-4 w-4 text-[#00DF89]" />
                                        </div>
                                        <span className="text-sm font-semibold text-white">Credit Facility</span>
                                    </div>
                                    <div className="text-2xl font-bold text-white tracking-tight">$25M+</div>
                    ...
                    >
                        <div className="inline-flex w-fit items-center rounded-full border border-stone-700 bg-stone-900/50 backdrop-blur-md px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-[#00DF89] shadow-sm">
                            <Landmark className="mr-2 h-3 w-3" />
                            Elite Credit Solutions
                        </div>
                        <h2 className="text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl italic leading-tight">
                            Liquidity Without <span className="bg-gradient-to-r from-[#00DF89] to-[#00b870] bg-clip-text text-transparent">Limits.</span>
                        </h2>
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-8 py-6 border-y border-stone-800">
                            <div>
                                <h4 className="text-3xl font-bold text-white italic">1.85%</h4>
                                <p className="text-xs text-stone-500 uppercase tracking-[0.15em] mt-2 font-medium">Starting APR</p>
                            </div>
                            <div>
                                <h4 className="text-3xl font-bold text-white italic">$25M+</h4>
                                <p className="text-xs text-stone-500 uppercase tracking-[0.15em] mt-2 font-medium">Max Credit Line</p>
                            </div>
                        </div>

                        <Button asChild size="lg" className="w-fit mt-4 bg-[#00DF89] text-black hover:bg-[#00c578] font-semibold">
                            <Link href="/sign-up">
