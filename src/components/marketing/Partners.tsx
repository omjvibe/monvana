...
export function Partners() {
    ...
    return (
        <section className="overflow-hidden bg-[#050505] py-12 md:py-16 border-y border-stone-900 relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-[2px] bg-[#00DF89]/10 blur-[20px] rounded-full pointer-events-none" />
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
                <motion.p
                    ...
                    viewport={{ once: true }}
                    className="text-center text-[10px] font-bold uppercase tracking-[0.3em] text-[#00DF89]/70"
                >
            ...
            <div className="relative mt-12 overflow-hidden">
                ...
                <div className="flex animate-[scroll_40s_linear_infinite] w-max">
                    {allPartners.map((partner, index) => (
                        ...
                        >
                            <div className="flex h-12 items-center justify-center rounded-xl border border-stone-800 bg-stone-900/30 px-8 py-2 transition-all duration-300 hover:border-[#00DF89]/40 hover:bg-stone-900/60 backdrop-blur-sm group">
                                <span className="text-xl font-bold italic text-stone-500 group-hover:text-stone-300 transition-colors">
                                    {partner.logo}
                                </span>
                            </div>
                        </div>
